...
public class ReceiverBroadcast extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        int type = intent.getIntExtra(MessagesSenderUtils.TYPE_EXTRA, 0);

        Intent intentToRepeat = new Intent(context, Start.class);
        ...
        NotificationManager nm = new MessagesSenderUtils().getNotificationManager(context);
